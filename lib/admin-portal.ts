export type AdminPortalSnapshot = {
  ...
  contents: Array<{ id: string; title: string; slug: string; summary: string; body: unknown; status: string; visibility?: string; content_type?: string; content_type_id?: string; unit_id?: string; unit_name?: string; updated_at: string; published_at?: string }>;
  ...
  media: Array<{ id: string; bucket: string; object_path: string; original_filename: string; mime_type: string; byte_size: number; status: string; alt_default?: string; caption_default?: string; created_at: string }>;

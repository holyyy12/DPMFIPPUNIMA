export type AdminPortalSnapshot = {
  ...
  comments: Array<{ id: string; thread_id: string; display_mode: string; display_name?: string; body: string; status: string; created_at: string; resource_type: string; resource_key: string; report_count: number }>;
  ...
  audit: Array<{ id: string; occurred_at: string; actor_name?: string; actor_type: string; action: string; target_type: string; result: string; reason?: string }>;
};

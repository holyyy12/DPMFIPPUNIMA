...
export function PublicHeader(){
 ...
 const {data}=usePublicPortal(); const home=data.settings['site.home'] as {logo?:string}|undefined;
 return <header className="v5-header"><div className="v5-shell v5-navbar">
  <Link href="/" className="v5-brand" onClick={()=>setOpen(false)}><img src={home?.logo??'/dpm-crest.png'} alt="Lambang DPM FIPP UNIMA"/><span><b>DPM FIPP UNIMA</b><small>Dewan Perwakilan Mahasiswa<br/>Fakultas Ilmu Pendidikan dan Psikologi</small></span></Link>

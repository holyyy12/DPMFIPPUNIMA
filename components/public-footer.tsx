  ...
  return (
    <footer>
      <div className="shell footer-grid">
        ...
        <div><b>Layanan</b><Link href="/ddas/kirim">Kirim Aspirasi</Link><Link href="/ddas/tracking">Lacak Aspirasi</Link><Link href="/survei">Survei</Link><Link href="/admin/login">Portal Admin</Link><Link href="https://median.co/share/pwokpqq#apk">Download Aplikasi DPM FIPP</Link></div>
        ...
        <div><b>Media Sosial</b><Link href="https://www.instagram.com/dpm_fipp_unima/" target="_blank">Instagram</Link><Link href="mailto:dpmfippunima@gmail.com" target="_blank">Email</Link></div>
      </div>

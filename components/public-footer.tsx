    ...
    <footer>
      <div className="shell footer-grid">
        <div>
          ...
          <p>
            Dewan Perwakilan Mahasiswa Fakultas Ilmu Pendidikan dan Psikologi
            Universitas Negeri Manado.
          </p>
        </div>
        <div>
          <b>Layanan</b>
          <Link href="/ddas/kirim">Kirim Aspirasi</Link>

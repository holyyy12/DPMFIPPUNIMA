...
export default function AdminDashboard() {
  return (
    <div className="admin-content">
      ...
      <div className="alert-banner"><ShieldCheck /><p><b>Fondasi keamanan disiapkan</b><span>Mode preview · Data sintetis · Backend baru dan MFA belum diprovisioning</span></p><Link href="/admin/settings">Lihat kontrol <ChevronRight /></Link></div>
